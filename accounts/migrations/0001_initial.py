    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_admin', 'Super Admin'), ('admin', 'Admin'), ('uploader', 'Uploader'), ('viewer', 'Viewer')], default='viewer', max_length=20)),
                ...
                ('email_verify_sent_at', models.DateTimeField(blank=True, null=True)),
                ('login_otp', models.CharField(blank=True, max_length=6)),
        ...
        migrations.CreateModel(
            name='PendingRoleRequest',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('requested_role', models.CharField(choices=[('super_admin', 'Super Admin'), ('admin', 'Admin'), ('uploader', 'Uploader'), ('viewer', 'Viewer')], max_length=20)),
